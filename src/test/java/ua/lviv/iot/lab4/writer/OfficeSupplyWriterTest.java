...
class OfficeSupplyWriterTest {
    ...
    void setUp() throws Exception {
        ...
        allSupplies
                .add(new Glue("GTX3", 120, 500, "Hungary", 3, "green", 5, 100));
        allSupplies.add(
                new Glue("GTX8", 125, 1500, "Hungary", 8, "green", 5, 100));
        allSupplies.add(
                new Glue("GTX11", 135, 1000, "Hungary", 11, "green", 5, 100));
        allSupplies.add(new Stapler("GTX5", 540, 1000, "USA", 5, "black", 12,
                "plastic"));
        allSupplies.add(new Stapler("GTX10", 540, 1000, "USA", 10, "black", 12,
                "plastic"));
        allSupplies.add(
                new Calculator("GTX2", 55, 1000, "France", 2, "grey", 10, 3));
        allSupplies.add(
                new Calculator("GTX6", 60, 1000, "France", 6, "grey", 10, 3));
        allSupplies.add(
                new Calculator("GTX7", 65, 1000, "France", 7, "grey", 10, 4));
        oneSubclassSupplies = new LinkedList<OfficeSupply>();
        oneSubclassSupplies.add(
                new Calculator("GTX2", 55, 1000, "France", 2, "grey", 10, 3));
        oneSubclassSupplies.add(
                new Calculator("GTX6", 60, 1000, "France", 6, "grey", 10, 3));
        oneSubclassSupplies.add(
    ...
    void testExpectedEmpty() throws IOException {
        ...
        try (BufferedReader expectedBF = new BufferedReader(new FileReader(
                "I:\\Games\\eclipse\\lab4\\lab4\\src\\test\\resources\\expectedEmpty.csv"));
                BufferedReader actualBF = new BufferedReader(
                        new FileReader("OfficeSupply.csv"))) {
